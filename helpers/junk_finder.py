...
# .parent.parent: this script lives in helpers/, but reports/ belongs to the repo root (and
# only that path is covered by the root-anchored /reports/ rule in .gitignore).
OUT = Path(__file__).resolve().parent.parent / 'reports' / 'junk_html_pdfs.csv'
